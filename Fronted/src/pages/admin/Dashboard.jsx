...
import { assets, dashboard_data } from '../../srcAssest';
...
const Dashboard = () => {
    ...
    const fetchDashboard = async () => {
        setDashboardData(dashboard_data); // Make sure `dashboard_data` is defined or fetched
    };
    ...
    return (
        <div className='flex-1 p-4 md:p-10 bg-blue-50/50'>
            ...
            <div className='flex mt-8 items-center gap-3 m-4 text-gray-700'>
